...
avg_income_for_position * create(worker * employee) {
  avg_income_for_position *tmp = (avg_income_for_position *)malloc(sizeof(avg_income_for_position));
  strcpy(tmp->position, employee->position);
